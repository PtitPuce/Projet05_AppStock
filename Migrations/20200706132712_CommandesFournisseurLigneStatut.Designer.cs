...
namespace AppStock.Migrations
{
    ...
    [Migration("20200706132712_CommandesFournisseurLigneStatut")]
    partial class CommandesFournisseurLigneStatut
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppStock.Models.CommandeFournisseurEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("commande_fournisseur_uid")
                        .HasColumnType("int");

                    b.Property<string>("Commentaire")
                        .HasColumnName("commande_fournisseur_commentaire")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("ContactId")
                        .HasColumnName("commande_fournisseur_contact_uid")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FournisseurId")
                        .HasColumnName("commande_fournisseur_fournisseur_uid")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NomCommandeFournisseurStatutId")
                        .HasColumnName("commande_fournisseur_statut_uid")
                        .HasColumnType("int");

                    b.Property<int>("NomCommandeFournisseurTypeId")
                        .HasColumnName("commande_fournisseur_type_uid")
                        .HasColumnType("int");

                    b.Property<string>("Numero")
                        .HasColumnName("commande_fournisseur_numero")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("AppStock.Models.CommandeFournisseurLigneEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("commande_fournisseur_ligne_uid")
                        .HasColumnType("int");

                    b.Property<int>("ArticleId")
                        .HasColumnName("commande_fournisseur_ligne_article_uid")
                        .HasColumnType("int");

                    b.Property<int>("CommandeFournisseurId")
                        .HasColumnName("commande_fournisseur_ligne_commande_fournisseur_uid")
                        .HasColumnType("int");

                    b.Property<int>("Quantite")
                        .HasColumnName("commande_fournisseur_ligne_quantite")
                        .HasColumnType("int");
                    ...
                    b.ToTable("app_commande_fournisseur_ligne");
                });
            ...
            modelBuilder.Entity("AppStock.Models.NomCommandeFournisseurStatutEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("commande_fournisseur_statut_uid")
                    ...
                    b.Property<string>("Code")
                        .IsRequired()
                        .HasColumnName("commande_fournisseur_statut_code")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<string>("Libelle")
                        .IsRequired()
                        .HasColumnName("commande_fournisseur_statut_libelle")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.HasKey("Id");

                    b.ToTable("app_nom_commande_fournisseur_statut");
                });
            ...
            modelBuilder.Entity("AppStock.Models.CommandeFournisseurEntity", b =>
                {
                    ...
                    b.HasOne("AppStock.Models.NomCommandeFournisseurStatutEntity", "NomCommandeFournisseurStatut")
                        .WithMany()
                        .HasForeignKey("NomCommandeFournisseurStatutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AppStock.Models.CommandeFournisseurLigneEntity", b =>
                {
                    ...
                    b.HasOne("AppStock.Models.CommandeFournisseurEntity", "CommandeFournisseur")
                        .WithMany("CommandeFournisseurLignes")
