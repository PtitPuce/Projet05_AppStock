...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppStock.Models.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AppStock.Models.ArticleFamille", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("article_famille_uid")
            ...
            modelBuilder.Entity("AppStock.Models.NomTypeTVA", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AppStock.Models.Stock", b =>
                {
            ...
            modelBuilder.Entity("AppStock.Models.Article", b =>
                {
                    b.HasOne("AppStock.Models.ArticleFamille", "ArticleFamille")
                        .WithMany("Articles")
                        .HasForeignKey("ArticleFamilleID");

                    b.HasOne("AppStock.Models.NomTypeTVA", "NomTypeTVA")
                        .WithMany()
            ...
            modelBuilder.Entity("AppStock.Models.Stock", b =>
                {
                    b.HasOne("AppStock.Models.Article", "Article")
                        .WithOne("Stock")
                        .HasForeignKey("AppStock.Models.Stock", "ArticleID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
